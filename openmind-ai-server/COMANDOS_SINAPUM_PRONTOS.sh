#!/bin/bash
# Execute estes comandos diretamente no servidor SinapUm (você já está conectado!)
...
echo "OPENMIND_AI_API_KEY=om1_live_7d4102a1bf72cc497d7651beb6a98292764b1f77df947c82d086506038ea6b9921efb9d9833045d1" >> .env && \
echo "" >> .env && \
...
echo "" && \
echo "✅ Pronto! Teste fazendo upload de uma imagem agora!"
